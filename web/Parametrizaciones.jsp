<%-- 
    Document   : Parametrizaciones
    Created on : 12/08/2018, 06:14:09 PM
    Author     : edwar
--%>
...
<html>
    <head>
        ...
        <link href="css/parametrizaciones.css" rel="stylesheet" type="text/css"/>
        <title>Parametrizaciones</title>
    </head>
    <body>
        <nav class="navbar">
